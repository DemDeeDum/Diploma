// <copyright file="ApplicationDatabaseContextInitializer.cs" company="PlaceholderCompany">
...
namespace Hotel.DataAccess.Context
{
    ...
    /// </summary>
    public class ApplicationDatabaseContextInitializer : CreateDatabaseIfNotExists<ApplicationDatabaseContext>
    {
        /// <summary>
        /// Seeds db.
        /// </summary>
        /// <param name="db">Database context to be seeded through.</param>
        protected override void Seed(ApplicationDatabaseContext db)
        {
